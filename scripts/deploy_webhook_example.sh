...

{
  ...
  write_env_line AIGRAM_CHAT_ID "${AIGRAM_CHAT_ID:-}"
  write_env_line AIGRAM_ACCESS_MODE "${AIGRAM_ACCESS_MODE:-admin}"
  write_env_line AIGRAM_ADMIN_USER_IDS "${AIGRAM_ADMIN_USER_IDS:-}"
  write_env_line AIGRAM_ALLOWED_USER_IDS "${AIGRAM_ALLOWED_USER_IDS:-}"
  write_env_line AIGRAM_ALLOWED_CHAT_IDS "${AIGRAM_ALLOWED_CHAT_IDS:-}"
  write_env_line AIGRAM_MEDIA_PATH "${AIGRAM_MEDIA_PATH:-}"
  write_env_line AIGRAM_FILE_ID "${AIGRAM_FILE_ID:-}"
} >"${tmp_dir}/service.env"
