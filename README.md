...
- Current local strategy: keep repository creation, push, tag, and release frozen until the user explicitly asks later; sensitive and state-changing areas remain manual-only for live smoke.
