...
<p align="center">
  <img alt="Coverage: 61.0%" src="https://img.shields.io/badge/coverage-61.0%25-F59E0B?style=for-the-badge">
  ...
  <img alt="Release: v0.7.0" src="https://img.shields.io/badge/release-v0.7.0-16A34A?style=for-the-badge">
...
- [`docs/releases/v0.7.0.md`](docs/releases/v0.7.0.md) — release notes for the current public release.
...
- [`docs/BOT_API_10_1_AUDIT.md`](docs/BOT_API_10_1_AUDIT.md) — Bot API 10.1 delta and implementation tracker.
