...
Webhook management is JSON-only for now. Webhook certificate upload, optional concrete chat member variant structs, FSM, scenes, storage, and dependency injection are not implemented yet. The Stage 98 final audit tracks the remaining Bot API 9.6 blocker.
