...
The earlier recommended order remains useful as the beginning of the full coverage workstream, but it is no longer a standalone v0.3 release plan:
...
Continue from the full Bot API 9.6 checklist instead of preparing a small v0.3 release.
